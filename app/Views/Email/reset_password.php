...
<head>
    ...
    <title>Reset Password - Schlemmer Employee Management System Application</title>
    <style>
        /* Reset CSS */
        * {
            margin: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="message">
                <p>Kami mendapatkan permintaan untuk melakukan reset password pada akun Schlemmer Employee Management System Anda. Berikut adalah password baru Anda:</p>
            </div>
